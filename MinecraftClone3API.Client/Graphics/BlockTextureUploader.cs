...
namespace MinecraftClone3API.Graphics
{
    ...
    /// (16/64/256/1024), then builds the mip chain on the GPU via <see cref="MipGenerator"/> (compute).
    ...
    public static class BlockTextureUploader
    {
        ...
        private static MipGenerator _mipGenerator;
