// Engine math aliases over Silk.NET.Maths: keep the familiar type names (Vector3, Vector3i, Matrix4, ...) so
// call sites read unchanged. The static helper classes (Vector3D.Dot, Matrix4X4.CreateTranslation,
// Scalar.Clamp) come from `using Silk.NET.Maths`; colours are Vector4D<float> and math goes through
// System.MathF / Silk.NET.Maths.Scalar.
