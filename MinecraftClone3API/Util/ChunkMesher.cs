...
namespace MinecraftClone3API.Util
{
    internal static class ChunkMesher
    {
        ...
        public static void AddBlockToVao(WorldBase world, Vector3i blockPos, int x, int y, int z, Block block,
            MeshBuffer vao, MeshBuffer transparentVao, Vector3 originOffset = default)
        {
        ...
        public static void AddFaceToVao(WorldBase world, Vector3i blockPos, int x, int y, int z, Block block, BlockFace face, BlockModel.FaceData data, MeshBuffer vao, Matrix4 transform, Vector3 originOffset = default, Vector4? lodLight = null)
        {
            ...
            for (var j = 0; j < 4; j++)
            {
                ...
                var position = (new Vector4(vertexPosition, 1) * transform).Xyz + blockPos.ToVector3() + originOffset;
